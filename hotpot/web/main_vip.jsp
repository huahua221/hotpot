...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：用户管理-> vip用户管理</td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;">
                        <a href="add_vip.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增vip</a>
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">推荐vip</th>
                    <th align="center" valign="middle" class="borderright">提成(%)</th>
                ...
                <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                    ...
                    <td align="center" valign="middle" class="borderright borderbottom">1598211234</td>
                    <td align="center" valign="middle" class="borderright borderbottom">东苑9舍</td>
                    <td align="center" valign="middle" class="borderright borderbottom">parent_vip_id</td>
                    ...
                    <td align="center" valign="middle" class="borderbottom">
                        ...
                        <!-- <button type="button" onFocus="this.blur()" class="v_btn1">修改提成比例</button>
                        <span class="gray">&nbsp;|&nbsp;</span> -->
                        <button type="button" onFocus="this.blur()" class="v_btn" onclick="deleteInfo()">删除</button>
                    </td>
                </tr>
            </table></td>
    </tr>
